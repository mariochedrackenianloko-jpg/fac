...
const testimonials = [
  {
    ...
    text: "Grâce à cette formation, j'ai lancé ma marque de savons naturels. Aujourd'hui, je génère plus de 300 000 FCFA par mois !",
    rating: 5,
  },
  {
    name: "Fatou D.",
    location: "Dakar, Sénégal",
    text: "L'ebook est très complet et facile à comprendre. Les recettes fonctionnent parfaitement avec les ingrédients locaux.",
    rating: 5,
  },
  {
    name: "Marie-Claire T.",
    location: "Douala, Cameroun",
    text: "Le groupe WhatsApp est incroyable. On s'entraide et on partage nos réussites. Je recommande à 100% !",
    rating: 5,
  },
];
...
export function TestimonialsSection() {
  return (
    <section id="temoignages" className="py-20 bg-gradient-dark">
